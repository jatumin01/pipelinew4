...
class CardGame(object):
    ...
    def GUI(self):
        ...
        cmds.iconTextButton( image='charMons.png',p='Monster')
        cmds.iconTextButton( image='blank.png',p='Monster')
        ...
        cmds.iconTextButton( image='backCard.png',p='Hero')
        ...
        cmds.iconTextButton("button0", image='backCard.png',c=buttonCard0)
        cmds.iconTextButton("button1", image='backCard.png',c=buttonCard1)
        cmds.iconTextButton("button2", image='backCard.png',c=buttonCard2)
